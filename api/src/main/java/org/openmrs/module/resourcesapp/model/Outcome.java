...
public class Outcome {
    ...
    public static List<Option> getAvailableOutcomes() {
        ...
        options.add(new Option(REVIEWED_OPTION, null, "已审核"));
        options.add(new Option(CURED_OPTION, null, "出院"));
        options.add(new Option(FOLLOW_UP_OPTION, null, "下次约会日期"));
        options.add(new Option(ADMIT_OPTION, null, "承认"));
        options.add(new Option(DIED_OPTION, null, "死了"));
        return options;
    }
